...
# v6 (collection stream) codecs
from sfproto.geojson.v6.geojson_featurecollection import (
    geojson_featurecollection_to_bytes_v6,
    bytes_to_geojson_featurecollection_v6,
)
from sfproto.geojson.v6.geojson_geometrycollection import (
    geojson_geometrycollection_to_bytes_v6,
    bytes_to_geojson_geometrycollection_v6,
)
...
_TAG_LEN = 4
_TAG_GEOM = b"GEOM"
_TAG_GCOL = b"GCOL"   # v6 GeometryCollectionStream payload
_TAG_FEAT = b"FEAT"
_TAG_FCOL = b"FCOL"   # v6 FeatureCollectionStream payload
